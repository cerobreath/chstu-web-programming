...
export default function Task10() {
    useEffect(() => {
        document.body.style.background = "linear-gradient(to right, #93c5fd, #d8b4fe, #f9a8d4)";
        return () => {
            document.body.style.background = ""; // Очищає фон після розмонтування компонента
        };
    }, []);
    ...
    return (
        <div className="flex flex-col text-lg items-center gap-5 p-6">
            ...
            <div className="text-lg">
                ...
                <p className="monospace">This paragraph uses a monospace font.</p>
            </div>
        </div>
    );
}
